...
$total_users_sql = "SELECT COUNT(*) as total FROM cliente";
...
$sql = "SELECT * FROM cliente LIMIT $users_per_page OFFSET $offset";
...
<header>
		<div class="header">
			...
			<div class="optionsBar">
				...
				<span>|</span>
				<span class="user">Guidaycri Peña</span>
		...
		<nav>
			<ul>
				...
				<li class="principal">
					<a href="#">Clientes</a>
					<ul>
						<li><a href="regClientes.php">Nuevo Cliente</a></li>
						<li><a href="visualizarClientes.php">Lista de Clientes</a></li>
					</ul>
				</li>
				<li class="principal">
    ...
    <a href="../regClientes.php" class="btn">Crear usuario</a>
            ...
            <tr>
                ...
                <td>
                    <button class="edit-btn" 
                        ...
                        data-correo="<?= $row['Telefono'] ?>" 
                        data-usuario="<?= $row['Direccion'] ?>" 
